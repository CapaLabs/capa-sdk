...
export class CapaV2Client {
    ...
    constructor(baseUrl: string, partnerApiKey: string) {
        ...
        this.webhookSettings = new WebhookSettingsService(this.partnerApiKey, openApiConfig);
        this.transactions = new TransactionsService(this.partnerApiKey, openApiConfig);
    }
}

export class OffRampService {
    constructor(private partnerApiKey: string, private openApiConfig: OpenAPIConfig) {}
...
export class QuotesService {
    ...
    public getPartnerQuoteRate(
        tokenSymbol: 'USDC' | 'USDT' | 'MXNe' | 'SOL' | 'ETH' | 'wBTC' | 'cbBTC' | 'PYSUD' | 'POL' | 'BNB' | 'WLD' | 'STK' | 'USDY' | 'CORE' | 'USDC.e' | 'wUSDL' | 'CoreBTC' | 'MATIC' | 'USDbC',
        transactionType: 'ON_RAMP' | 'OFF_RAMP',
        blockchainSymbol: 'POL' | 'SOL' | 'BASE' | 'ARB' | 'BSC' | 'OP' | 'WLD' | 'STK' | 'ETH' | 'MTN' | 'CORE',
...
export class KycService {
    ...
    public getUserVerificationDetails(
        userId: string,
    ): CancelablePromise<{
        status?: string;
...
export class UsersService {
    ...
    public createUser(
        requestBody: CreatePartnerUserBody,
    ): CancelablePromise<{
        success?: boolean;
...
export class TransactionsService {
    ...
    public cancelPartnerTransaction(
        id: string,
    ): CancelablePromise<{
        success?: boolean;
    ...
    public listPartnerUserTransactions(
        id?: string,
        status?: 'FAILED' | 'COMPLETED' | 'PENDING' | 'PENDING_PAYMENT' | 'FIAT_PAYMENT_RECEIVED' | 'FIAT_RECEIVED' | 'CRYPTO_RECEIVED' | 'CRYPTO_NOT_RECEIVED' | 'COMPLETED_CRYPTO_RECEIVAL' | 'EXPIRED' | 'CANCELLED' | 'IN_PROGRESS' | 'BANK_TRANSFER_PENDING' | 'READY_BANK_TRANSFER' | 'AWAITING_MANUAL_CRYPTO_TRANSFER' | 'AWAITING_MANUAL_FIAT_TRANSFER',
